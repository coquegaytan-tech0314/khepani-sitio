...
def patch(html: str) -> str:
    ...
    # Primaria building / gallery slots → Sep18 facade
    html = re.sub(
    ...
    # Keep Sep17 secundaria for niveles; strip residual data-k
    html = re.sub(
    ...
    # Covered cancha wide slot → Sep18 JPEG, no data-k
    html = re.sub(
    ...
    # Inject only missing Sep18 gallery accents (after first campus gallery figure)

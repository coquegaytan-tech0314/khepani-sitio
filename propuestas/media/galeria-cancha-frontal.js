...
(function(key,n){
  ...
  function done(){
    ...
    document.querySelectorAll('img[data-k="'+key+'"],link[data-k="'+key+'"]').forEach(function(el){
      var u=window.KHEPANI_IMG[key]; if(!u) return;
      if(el.tagName==='LINK') el.href=u; else el.src=u;
    });
  }
  for (var i=0;i<n;i++){
    (function(i){
